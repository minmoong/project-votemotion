function RegisterIcon(isHover: boolean) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 24 24" height="24px" viewBox="0 0 24 24" width="24px" fill={ isHover ? "#ffffff" : "#0d6efd" }>
      <g>
